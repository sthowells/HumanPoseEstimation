...
out = cv2.VideoWriter('output/EyesDirection.avi', fourcc, 30.0, (640,480))
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            Reye_3d_projection, jacobian = cv2.projectPoints(Reye_3d, rot_vec, trans_vec, cam_matrix, dist_matrix)
